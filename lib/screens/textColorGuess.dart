...
class TextColorGuess extends StatefulWidget {
  const TextColorGuess({Key? key}) : super(key: key);

  @override
  TtextColorGuessState createState() => TtextColorGuessState();
}

class TtextColorGuessState extends State<TextColorGuess> {
